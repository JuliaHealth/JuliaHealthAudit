...
Thanks for taking the time to contribute to PackageName.jl! ❤️
...
First off, we assume that you have read the available [Link to Documentation](..).

Before you report an issue, it is best to search for existing [Link to Issues](..) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue.

If you then still feel the need to report an issue, we recommend the following:

- Open an [Link to Issue](..).
...
By contributing to PackageName.jl, you agree that your contributions will be licensed under the [Link to License](..).
