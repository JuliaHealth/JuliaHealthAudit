...
This package is registered in the General Registry. Install it using the Julia package manager:
...
```julia
using Pkg
Pkg.add(url="https://github.com/JuliaHealth/PackageName.jl")
```
...
```bibtex
@software{packagename_jl,
  author = {Author Name},
  title = {PackageName.jl: Brief description},
  year = {2026},
  url = {https://github.com/JuliaHealth/PackageName.jl}
}
```
